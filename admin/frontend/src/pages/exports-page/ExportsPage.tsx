  ...
  return (
    <PageLayout>
      <div className="d-flex flex-column gap-4">
        ...
        <h1 className="mb-1">Data exports</h1>
          ...
          <Card.Body>
              ...
              <Col md={4}>
                <Form.Group controlId="export-dataset">
                  ...
                  <Form.Select
                    ...
                    onChange={(event) =>
                      filters.handlers.handleSelectDataset(event.target.value)
                    }
              ...
              <Col md={4}>
                <Form.Group controlId="export-district">
                  ...
                  <Form.Select
                    ...
                    onChange={(event) =>
                      filters.handlers.setSelectedDistrict(event.target.value)
                    }
                    disabled={!datasets.selected || filters.isLoading}
                  >
                    <option value="">
                      {filters.isLoading
                        ? 'Loading districts...'
              ...
              <Col md={4}>
                <Form.Group controlId="export-resource-type">
                  ...
                  <Form.Select
                    ...
                    onChange={(event) =>
                      filters.handlers.setSelectedResourceType(
                        event.target.value,
                      )
                    }
                    disabled={!datasets.selected || filters.isLoading}
            ...
            {datasets.selected ? (
              <p className="mt-3 mb-0 text-muted">
                Source: {datasets.selected.source}
              </p>
            ) : null}
            ...
            <div className="d-flex gap-2 mt-3">
              ...
              >
                {download.isDownloading ? (
                  <span className="d-inline-flex justify-content-center w-100">
            ...
            {datasets.selected &&
            isDatasetUnavailable(datasets.selected.info) ? (
              <p className="mt-3 mb-0 text-muted">
          ...
          <Card.Body>
            ...
            {!preview.isEnabled ? (
              <p className="mb-0 text-muted">
                ...
                backend. District and type changes refresh the preview.
              </p>
            ) : null}
            ...
            {preview.isEnabled && !preview.isLoading && preview.data ? (
              <DataTable
                ...
                getRowKey={(row, rowIndex) =>
                  `${row.FOREST_FILE_ID ?? 'row'}-${rowIndex}`
                }
