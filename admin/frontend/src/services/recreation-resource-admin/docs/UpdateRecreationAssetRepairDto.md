...
```typescript
import type { UpdateRecreationAssetRepairDto } from ''
...
const example = {
  ...
  "asset_id": 1,
} satisfies UpdateRecreationAssetRepairDto
...
const exampleParsed = JSON.parse(exampleJSON) as UpdateRecreationAssetRepairDto
