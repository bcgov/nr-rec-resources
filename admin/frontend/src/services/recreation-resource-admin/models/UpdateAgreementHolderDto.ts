 ...
 *
 * @export
 * @interface UpdateAgreementHolderDto
 */
...
/**
 * Check if a given object implements the UpdateAgreementHolderDto interface.
 */
export function instanceOfUpdateAgreementHolderDto(
  value: object,
): value is UpdateAgreementHolderDto {
  return true;
}

export function UpdateAgreementHolderDtoFromJSON(
  json: any,
): UpdateAgreementHolderDto {
  return UpdateAgreementHolderDtoFromJSONTyped(json, false);
}

export function UpdateAgreementHolderDtoFromJSONTyped(
  json: any,
...
export function UpdateAgreementHolderDtoToJSON(
  json: any,
): UpdateAgreementHolderDto {
  return UpdateAgreementHolderDtoToJSONTyped(json, false);
}

export function UpdateAgreementHolderDtoToJSONTyped(
  value?: UpdateAgreementHolderDto | null,
