 ...
 *
 * @export
 * @interface UpdateAssetFieldsDto
 */
export interface UpdateAssetFieldsDto {
  /**
...
/**
 * Check if a given object implements the UpdateAssetFieldsDto interface.
 */
export function instanceOfUpdateAssetFieldsDto(
  value: object,
): value is UpdateAssetFieldsDto {
  return true;
}

export function UpdateAssetFieldsDtoFromJSON(json: any): UpdateAssetFieldsDto {
  return UpdateAssetFieldsDtoFromJSONTyped(json, false);
}

export function UpdateAssetFieldsDtoFromJSONTyped(
  json: any,
...
export function UpdateAssetFieldsDtoToJSON(json: any): UpdateAssetFieldsDto {
  return UpdateAssetFieldsDtoToJSONTyped(json, false);
}

export function UpdateAssetFieldsDtoToJSONTyped(
  value?: UpdateAssetFieldsDto | null,
