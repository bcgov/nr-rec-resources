 ...
 *
 * @export
 * @interface ActAdvisoryBulkUpsertDto
 */
...
/**
 * Check if a given object implements the ActAdvisoryBulkUpsertDto interface.
 */
export function instanceOfActAdvisoryBulkUpsertDto(
  value: object,
): value is ActAdvisoryBulkUpsertDto {
  ...
  if (!('modified_date' in value) || value['modified_date'] === undefined)
    return false;
  if (!('rec_resource_ids' in value) || value['rec_resource_ids'] === undefined)
    return false;
  return true;
}

export function ActAdvisoryBulkUpsertDtoFromJSON(
  json: any,
): ActAdvisoryBulkUpsertDto {
  return ActAdvisoryBulkUpsertDtoFromJSONTyped(json, false);
}

export function ActAdvisoryBulkUpsertDtoFromJSONTyped(
  json: any,
  ...
  return {
    ...
    rec_resource_ids: new Set(json['rec_resource_ids']),
  };
}

export function ActAdvisoryBulkUpsertDtoToJSON(
  json: any,
): ActAdvisoryBulkUpsertDto {
  return ActAdvisoryBulkUpsertDtoToJSONTyped(json, false);
}

export function ActAdvisoryBulkUpsertDtoToJSONTyped(
  value?: ActAdvisoryBulkUpsertDto | null,
  ...
  return {
    ...
    rec_resource_ids: Array.from(value['rec_resource_ids'] as Set<any>),
  };
}
