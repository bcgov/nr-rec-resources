...
import type { BcgwRecreationPolygonsDto } from './BcgwRecreationPolygonsDto';
import {
  BcgwRecreationPolygonsDtoFromJSON,
  BcgwRecreationPolygonsDtoFromJSONTyped,
  BcgwRecreationPolygonsDtoToJSON,
  BcgwRecreationPolygonsDtoToJSONTyped,
} from './BcgwRecreationPolygonsDto';

/**
 *
 * @export
 * @interface BcgwRecreationPolygonsFeatureDto
 */
...
/**
 * Check if a given object implements the BcgwRecreationPolygonsFeatureDto interface.
 */
export function instanceOfBcgwRecreationPolygonsFeatureDto(
  value: object,
): value is BcgwRecreationPolygonsFeatureDto {
...
export function BcgwRecreationPolygonsFeatureDtoFromJSON(
  json: any,
): BcgwRecreationPolygonsFeatureDto {
  return BcgwRecreationPolygonsFeatureDtoFromJSONTyped(json, false);
}

export function BcgwRecreationPolygonsFeatureDtoFromJSONTyped(
  json: any,
  ...
  return {
    ...
    properties: BcgwRecreationPolygonsDtoFromJSON(json['properties']),
  };
}

export function BcgwRecreationPolygonsFeatureDtoToJSON(
  json: any,
): BcgwRecreationPolygonsFeatureDto {
  return BcgwRecreationPolygonsFeatureDtoToJSONTyped(json, false);
}

export function BcgwRecreationPolygonsFeatureDtoToJSONTyped(
  value?: BcgwRecreationPolygonsFeatureDto | null,
  ...
  return {
    ...
    properties: BcgwRecreationPolygonsDtoToJSON(value['properties']),
  };
}
