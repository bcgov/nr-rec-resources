 ...
 *
 * @export
 * @interface CreateRecreationAssetDto
 */
...
/**
 * Check if a given object implements the CreateRecreationAssetDto interface.
 */
export function instanceOfCreateRecreationAssetDto(
  value: object,
): value is CreateRecreationAssetDto {
...
export function CreateRecreationAssetDtoFromJSON(
  json: any,
): CreateRecreationAssetDto {
  return CreateRecreationAssetDtoFromJSONTyped(json, false);
}

export function CreateRecreationAssetDtoFromJSONTyped(
  json: any,
...
export function CreateRecreationAssetDtoToJSON(
  json: any,
): CreateRecreationAssetDto {
  return CreateRecreationAssetDtoToJSONTyped(json, false);
}

export function CreateRecreationAssetDtoToJSONTyped(
  value?: CreateRecreationAssetDto | null,
