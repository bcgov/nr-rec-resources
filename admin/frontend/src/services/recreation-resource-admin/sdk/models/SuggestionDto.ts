...
export function instanceOfSuggestionDto(value: object): value is SuggestionDto {
    ...
    if (!('recreation_resource_type' in value) || value['recreation_resource_type'] === undefined) return false;
    if (!('recreation_resource_type_code' in value) || value['recreation_resource_type_code'] === undefined) return false;
    if (!('district_description' in value) || value['district_description'] === undefined) return false;
    return true;
}
...
export function SuggestionDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): SuggestionDto {
    if (json == null) {
        return json;
    }
    return {
...
export function SuggestionDtoToJSONTyped(value?: SuggestionDto | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
