 ...
 * @param text
 */
export const getRecreationResourceSuggestions: (text: string) => $runtime.TypedSql<getRecreationResourceSuggestions.Parameters, getRecreationResourceSuggestions.Result>
