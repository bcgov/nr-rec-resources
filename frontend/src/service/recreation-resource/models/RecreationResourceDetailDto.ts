...
export function instanceOfRecreationResourceDetailDto(value: object): value is RecreationResourceDetailDto {
    ...
    if (!('recreation_resource_images' in value) || value['recreation_resource_images'] === undefined) return false;
    if (!('description' in value) || value['description'] === undefined) return false;
    if (!('recreation_campsite' in value) || value['recreation_campsite'] === undefined) return false;
...
export function RecreationResourceDetailDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecreationResourceDetailDto {
    ...
    return {
        ...
        'recreation_resource_images': ((json['recreation_resource_images'] as Array<any>).map(RecreationResourceImageDtoFromJSON)),
        'description': json['description'],
        'recreation_campsite': RecreationCampsiteDtoFromJSON(json['recreation_campsite']),
...
export function RecreationResourceDetailDtoToJSONTyped(value?: RecreationResourceDetailDto | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'recreation_resource_images': ((value['recreation_resource_images'] as Array<any>).map(RecreationResourceImageDtoToJSON)),
        'description': value['description'],
        'recreation_campsite': RecreationCampsiteDtoToJSON(value['recreation_campsite']),
