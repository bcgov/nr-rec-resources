 ...
 */
export function instanceOfFilterOptionDto(value: object): value is FilterOptionDto {
...
export function FilterOptionDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): FilterOptionDto {
    if (json == null) {
        return json;
    }
    return {
...
export function FilterOptionDtoToJSONTyped(value?: FilterOptionDto | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
