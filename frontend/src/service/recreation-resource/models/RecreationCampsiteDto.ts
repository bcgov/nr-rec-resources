 ...
 */
export function instanceOfRecreationCampsiteDto(value: object): value is RecreationCampsiteDto {
...
export function RecreationCampsiteDtoFromJSON(json: any): RecreationCampsiteDto {
    return RecreationCampsiteDtoFromJSONTyped(json, false);
}

export function RecreationCampsiteDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecreationCampsiteDto {
    if (json == null) {
        return json;
    }
    return {
...
export function RecreationCampsiteDtoToJSONTyped(value?: RecreationCampsiteDto | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
