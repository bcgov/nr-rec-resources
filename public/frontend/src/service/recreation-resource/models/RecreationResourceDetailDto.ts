...
export type RecreationResourceDetailDtoMaintenanceStandardCodeEnum = typeof RecreationResourceDetailDtoMaintenanceStandardCodeEnum[keyof typeof RecreationResourceDetailDtoMaintenanceStandardCodeEnum];


/**
 * Check if a given object implements the RecreationResourceDetailDto interface.
 */
export function instanceOfRecreationResourceDetailDto(value: object): value is RecreationResourceDetailDto {
    ...
    if (!('driving_directions' in value) || value['driving_directions'] === undefined) return false;
    if (!('maintenance_standard_code' in value) || value['maintenance_standard_code'] === undefined) return false;
    if (!('campsite_count' in value) || value['campsite_count'] === undefined) return false;
    if (!('recreation_fee' in value) || value['recreation_fee'] === undefined) return false;
    if (!('recreation_access' in value) || value['recreation_access'] === undefined) return false;
    if (!('additional_fees' in value) || value['additional_fees'] === undefined) return false;
    if (!('recreation_structure' in value) || value['recreation_structure'] === undefined) return false;
    return true;
}

export function RecreationResourceDetailDtoFromJSON(json: any): RecreationResourceDetailDto {
    return RecreationResourceDetailDtoFromJSONTyped(json, false);
}

export function RecreationResourceDetailDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecreationResourceDetailDto {
    if (json == null) {
        return json;
    }
    return {
        ...
        'recreation_fee': ((json['recreation_fee'] as Array<any>).map(RecreationFeeDtoFromJSON)),
        'recreation_access': json['recreation_access'],
        'additional_fees': ((json['additional_fees'] as Array<any>).map(RecreationFeeDtoFromJSON)),
        'recreation_structure': RecreationStructureDtoFromJSON(json['recreation_structure']),
        ...
        'recreation_resource_docs': json['recreation_resource_docs'] == null ? undefined : ((json['recreation_resource_docs'] as Array<any>).map(RecreationResourceDocDtoFromJSON)),
        'recreation_district': json['recreation_district'] == null ? undefined : RecreationResourceDistrictDtoFromJSON(json['recreation_district']),
    };
}

export function RecreationResourceDetailDtoToJSON(json: any): RecreationResourceDetailDto {
    return RecreationResourceDetailDtoToJSONTyped(json, false);
}

export function RecreationResourceDetailDtoToJSONTyped(value?: RecreationResourceDetailDto | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'recreation_fee': ((value['recreation_fee'] as Array<any>).map(RecreationFeeDtoToJSON)),
        'recreation_access': value['recreation_access'],
        'additional_fees': ((value['additional_fees'] as Array<any>).map(RecreationFeeDtoToJSON)),
        'recreation_structure': RecreationStructureDtoToJSON(value['recreation_structure']),
        'spatial_feature_geometry': value['spatial_feature_geometry'],
        'site_point_geometry': value['site_point_geometry'],
        'recreation_resource_docs': value['recreation_resource_docs'] == null ? undefined : ((value['recreation_resource_docs'] as Array<any>).map(RecreationResourceDocDtoToJSON)),
        'recreation_district': RecreationResourceDistrictDtoToJSON(value['recreation_district']),
    };
}
