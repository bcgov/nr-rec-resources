...
export type RecreationResourceDocDtoDocCodeEnum = typeof RecreationResourceDocDtoDocCodeEnum[keyof typeof RecreationResourceDocDtoDocCodeEnum];


/**
 * Check if a given object implements the RecreationResourceDocDto interface.
 */
export function instanceOfRecreationResourceDocDto(value: object): value is RecreationResourceDocDto {
    ...
    if (!('doc_code_description' in value) || value['doc_code_description'] === undefined) return false;
    if (!('extension' in value) || value['extension'] === undefined) return false;
    return true;
}

export function RecreationResourceDocDtoFromJSON(json: any): RecreationResourceDocDto {
    return RecreationResourceDocDtoFromJSONTyped(json, false);
}

export function RecreationResourceDocDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecreationResourceDocDto {
    if (json == null) {
        return json;
    }
    return {
...
export function RecreationResourceDocDtoToJSON(json: any): RecreationResourceDocDto {
    return RecreationResourceDocDtoToJSONTyped(json, false);
}

export function RecreationResourceDocDtoToJSONTyped(value?: RecreationResourceDocDto | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
