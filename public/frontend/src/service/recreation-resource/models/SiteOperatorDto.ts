 ...
 */
export function instanceOfSiteOperatorDto(
  value: object,
): value is SiteOperatorDto {
  if (!('clientNumber' in value) || value['clientNumber'] === undefined)
    return false;
  if (!('clientName' in value) || value['clientName'] === undefined)
    return false;
  if (!('legalFirstName' in value) || value['legalFirstName'] === undefined)
    return false;
  if (!('legalMiddleName' in value) || value['legalMiddleName'] === undefined)
    return false;
  if (!('clientStatusCode' in value) || value['clientStatusCode'] === undefined)
    return false;
  if (!('clientTypeCode' in value) || value['clientTypeCode'] === undefined)
    return false;
...
export function SiteOperatorDtoFromJSONTyped(
  json: any,
...
export function SiteOperatorDtoToJSONTyped(
  value?: SiteOperatorDto | null,
