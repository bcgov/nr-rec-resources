 ...
 */
export function instanceOfRecreationFeeDto(value: object): value is RecreationFeeDto {
    if (!('fee_amount' in value) || value['fee_amount'] === undefined) return false;
    if (!('fee_start_date' in value) || value['fee_start_date'] === undefined) return false;
    if (!('fee_end_date' in value) || value['fee_end_date'] === undefined) return false;
    if (!('recreation_fee_code' in value) || value['recreation_fee_code'] === undefined) return false;
    if (!('monday_ind' in value) || value['monday_ind'] === undefined) return false;
    if (!('tuesday_ind' in value) || value['tuesday_ind'] === undefined) return false;
    if (!('wednesday_ind' in value) || value['wednesday_ind'] === undefined) return false;
    if (!('thursday_ind' in value) || value['thursday_ind'] === undefined) return false;
    if (!('friday_ind' in value) || value['friday_ind'] === undefined) return false;
    if (!('saturday_ind' in value) || value['saturday_ind'] === undefined) return false;
    if (!('sunday_ind' in value) || value['sunday_ind'] === undefined) return false;
    return true;
}
...
export function RecreationFeeDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecreationFeeDto {
    if (json == null) {
        return json;
    }
    return {
...
export function RecreationFeeDtoToJSONTyped(value?: RecreationFeeDto | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
