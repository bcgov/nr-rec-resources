 ...
 * Add new filter categories here to maintain consistency.
 */
const FILTER_CONFIG = [
 ...
 * @returns Array of FilterDto objects representing the complete filter menu
 */
