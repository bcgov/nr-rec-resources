      ...
      await this.prisma.$transaction([
        ...
        this.prisma.$queryRaw<any[]>`
          ...
          select
            ...
            cast(count(distinct case when fr.has_toilets = true then fr.rec_resource_id end) as int) as total_toilet_count,
            cast(count(distinct case when fr.has_tables = true then fr.rec_resource_id end) as int) as total_table_count,
