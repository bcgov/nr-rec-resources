...
TypeScript scripts for maintenance and operations. Each feature area lives under `src/<feature>/` and has its own **Makefile** for running scripts (no npm scripts per feature in this package).
