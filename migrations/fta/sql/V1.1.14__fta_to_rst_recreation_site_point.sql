insert into rst.recreation_site_point (rec_resource_id, geometry, revision_count, updated_at, updated_by, created_at,
                                       created_by)
select distinct on (frsp.forest_file_id, frsp.geometry) frsp.forest_file_id   as rec_resource_id,
                                                        frsp.geometry,
                                                        frsp.revision_count,
...
on conflict (rec_resource_id, geometry)
    do update
