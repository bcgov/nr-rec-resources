...
comment on column rst.recreation_resource.rec_status_code is 'Site status value for a recreation resource. Sourced from fta.recreation_file_status_code.file_status_st.';
