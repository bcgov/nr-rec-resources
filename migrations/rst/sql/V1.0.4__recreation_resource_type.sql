...
select upsert_timestamp_columns('rst', 'recreation_resource_type_code', true);
...
create index idx_recreation_resource_type_rec_resource_type_code on rst.recreation_resource_type(rec_resource_type_code);
