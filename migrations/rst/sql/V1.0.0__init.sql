...
create table if not exists rst.recreation_resource (
    ...
    recreation_map_feature_code varchar(50)
);
...
comment on column rst.recreation_resource.recreation_map_feature_code is 'Code representing a specific feature associated with the recreation resource.';
