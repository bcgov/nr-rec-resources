...
public class RecreationProject {
  ...
  @JoinColumn(name = "RECREATION_CONTROL_ACCESS_CODE")
  private RecreationControlAccessCode recreationControlAccessCode;

  @ManyToOne(fetch = FetchType.LAZY)
  @OnDelete(action = OnDeleteAction.RESTRICT)
  @JoinColumn(name = "RECREATION_FEATURE_CODE")
  private RecreationFeatureCode recreationFeatureCode;

  @ManyToOne(fetch = FetchType.LAZY)
  @OnDelete(action = OnDeleteAction.RESTRICT)
  @JoinColumn(name = "RECREATION_MAINTAIN_STD_CODE")
  private RecreationMaintainStdCode recreationMaintainStdCode;

  @ManyToOne(fetch = FetchType.LAZY)
  @OnDelete(action = OnDeleteAction.RESTRICT)
  @JoinColumn(name = "RECREATION_RISK_RATING_CODE")
  private RecreationRiskRatingCode recreationRiskRatingCode;
  ...
  @ManyToOne(fetch = FetchType.LAZY)
  @OnDelete(action = OnDeleteAction.RESTRICT)
  @JoinColumn(name = "RECREATION_USER_DAYS_CODE")
  ...
  public RecreationControlAccessCode getRecreationControlAccessCode() {
    return recreationControlAccessCode;
  }

  public void setRecreationControlAccessCode(RecreationControlAccessCode recreationControlAccessCode) {
    this.recreationControlAccessCode = recreationControlAccessCode;
  }

  public RecreationFeatureCode getRecreationFeatureCode() {
    return recreationFeatureCode;
  }

  public void setRecreationFeatureCode(RecreationFeatureCode recreationFeatureCode) {
    this.recreationFeatureCode = recreationFeatureCode;
  }

  public RecreationMaintainStdCode getRecreationMaintainStdCode() {
    return recreationMaintainStdCode;
  }

  public void setRecreationMaintainStdCode(RecreationMaintainStdCode recreationMaintainStdCode) {
    this.recreationMaintainStdCode = recreationMaintainStdCode;
  }

  public RecreationRiskRatingCode getRecreationRiskRatingCode() {
    return recreationRiskRatingCode;
  }

  public void setRecreationRiskRatingCode(RecreationRiskRatingCode recreationRiskRatingCode) {
