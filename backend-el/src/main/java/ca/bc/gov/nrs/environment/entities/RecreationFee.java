...
public class RecreationFee {
  ...
  @ManyToOne(fetch = FetchType.LAZY, optional = false)
  @OnDelete(action = OnDeleteAction.RESTRICT)
  @JoinColumn(name = "RECREATION_FEE_CODE", nullable = false)
  private RecreationFeeCode recreationFeeCode;
  ...
  public RecreationFeeCode getRecreationFeeCode() {
    return recreationFeeCode;
  }

  public void setRecreationFeeCode(RecreationFeeCode recreationFeeCode) {
