  ...
  security_headers_config {
    content_security_policy {
      ...
      content_security_policy = join("; ", [
        ...
        "connect-src 'self' ${local.api_url} https://${var.app_env}.loginproxy.gov.bc.ca https://loginproxy.gov.bc.ca https://services6.arcgis.com https://www.arcgis.com https://services.arcgis.com https://tiles.arcgis.com https://maps.arcgis.com https://maps.gov.bc.ca ${var.csp_urls.connect_src} ${var.csp_urls.matomo_src}",
        "media-src 'self'",
        "frame-src 'none'",
