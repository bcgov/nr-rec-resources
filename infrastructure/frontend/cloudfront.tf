  ...
  security_headers_config {
    content_security_policy {
      ...
      content_security_policy = join("; ", [
        ...
        "connect-src 'self' ${local.api_url} ${local.establishment_order_docs_s3_url} ${local.storage_cloudfront_url} https://rst-storage-*-${var.target_env}.s3.ca-central-1.amazonaws.com https://${var.app_env}.loginproxy.gov.bc.ca https://loginproxy.gov.bc.ca https://services6.arcgis.com https://www.arcgis.com https://services.arcgis.com https://tiles.arcgis.com https://maps.arcgis.com https://basemaps.arcgis.com ${var.csp_urls.connect_src} ${var.csp_urls.matomo_src}",
        "media-src 'self'",
